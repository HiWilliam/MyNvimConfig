...
km.set("n", "<leader>gu", "<Esc><cmd> Gitsigns setqflist all open=false <CR> | :Telescope quickfix<CR>", {})
km.set("n", "<leader>l", "<Esc><cmd>lua vim.diagnostic.setloclist({open = false})<CR> | :Telescope loclist<CR>", {})
